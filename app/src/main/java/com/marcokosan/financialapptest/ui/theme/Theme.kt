...
private val LocalExtendedColorsScheme = staticCompositionLocalOf {
    ExtendedColorScheme(
...
val extendedColorScheme: ExtendedColorScheme
    @Composable @ReadOnlyComposable get() = LocalExtendedColorsScheme.current
...
fun DesignSystemTheme(
    ...
    CompositionLocalProvider(
        LocalExtendedColorsScheme provides extendedColorScheme
    ) {
        MaterialTheme(
